...
def main():
    ...
    sites_path = os.path.join(repo_root, args.sites or f"HeCBench/results/llvm17_inject/matrix-rotate/sites{suffix}.csv")
    sites_rich_path = os.path.join(
        repo_root, args.sites_rich or f"HeCBench/results/llvm17_inject/matrix-rotate/sites{suffix}_metadata.csv"
    )
    ...
    worklist_path = os.path.join(repo_root, args.worklist or f"HeCBench/results/llvm17_inject/matrix-rotate/worklist{suffix}.csv")
