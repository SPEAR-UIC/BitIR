; ModuleID = '/tmp/bitir_exploratory_v4_amd_entropy_site482_bit0_trial2/device.injected.bc'
...
@__hip_cuid_541bb26628b5d661 = addrspace(1) global i8 0
@llvm.compiler.used = appending addrspace(1) global [1 x ptr] [ptr addrspacecast (ptr addrspace(1) @__hip_cuid_541bb26628b5d661 to ptr)], section "llvm.metadata"
...
92:                                               ; preds = %85
  ...
  %fi_op_xor = xor i64 %114, 1
  %119 = or i64 %fi_op_xor, %118
