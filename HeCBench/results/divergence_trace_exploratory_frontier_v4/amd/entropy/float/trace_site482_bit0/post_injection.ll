; ModuleID = '/tmp/bitir_exploratory_v4_amd_entropy_site482_bit0_trial1/device.injected.bc'
...
@__hip_cuid_70e2d3b228c289 = addrspace(1) global i8 0
@llvm.compiler.used = appending addrspace(1) global [1 x ptr] [ptr addrspacecast (ptr addrspace(1) @__hip_cuid_70e2d3b228c289 to ptr)], section "llvm.metadata"
