; ModuleID = '/tmp/bitir_exploratory_v4_amd_entropy_site392_bit0_trial1/device.injected.bc'
...
@__hip_cuid_6b5b559694f1b016 = addrspace(1) global i8 0
@llvm.compiler.used = appending addrspace(1) global [1 x ptr] [ptr addrspacecast (ptr addrspace(1) @__hip_cuid_6b5b559694f1b016 to ptr)], section "llvm.metadata"
