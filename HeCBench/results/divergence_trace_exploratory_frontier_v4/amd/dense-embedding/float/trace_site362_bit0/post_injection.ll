; ModuleID = '/tmp/bitir_exploratory_v4_amd_dense-embedding_site362_bit0_trial1/device.injected.bc'
...
@__hip_cuid_86d4ba6ea6b9b364 = addrspace(1) global i8 0
@llvm.compiler.used = appending addrspace(1) global [1 x ptr] [ptr addrspacecast (ptr addrspace(1) @__hip_cuid_86d4ba6ea6b9b364 to ptr)], section "llvm.metadata"
