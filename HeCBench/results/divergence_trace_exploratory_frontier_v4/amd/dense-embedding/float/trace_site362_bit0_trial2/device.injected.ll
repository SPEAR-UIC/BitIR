; ModuleID = '/tmp/bitir_exploratory_v4_amd_dense-embedding_site362_bit0_trial2/device.injected.bc'
...
@__hip_cuid_46b6a1db93858d77 = addrspace(1) global i8 0
@llvm.compiler.used = appending addrspace(1) global [1 x ptr] [ptr addrspacecast (ptr addrspace(1) @__hip_cuid_46b6a1db93858d77 to ptr)], section "llvm.metadata"
