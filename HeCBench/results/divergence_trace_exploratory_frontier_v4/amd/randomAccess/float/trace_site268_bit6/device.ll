; ModuleID = '/autofs/nccs-svm1_home2/mdunlavy/GPU_FI/HeCBench/src/randomAccess-hip/main.cu'
...
@__hip_cuid_2128f547f55c9d50 = addrspace(1) global i8 0
@llvm.compiler.used = appending addrspace(1) global [1 x ptr] [ptr addrspacecast (ptr addrspace(1) @__hip_cuid_2128f547f55c9d50 to ptr)], section "llvm.metadata"
