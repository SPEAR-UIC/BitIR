; ModuleID = '/var/tmp/pbs.7230199.polaris-pbs-01.hsn.cm.polaris.alcf.anl.gov/bitir_nvidia_entropy_site16_bit0/device.injected.bc'
...
lor.lhs.false:                                    ; preds = %entry
  ...
  %fi_flip = xor i1 %cmp8, true, !dbg !1198
  br i1 %fi_flip, label %if.then, label %if.end, !dbg !1198
