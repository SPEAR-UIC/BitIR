; ModuleID = '/tmp/bitir_amd_colorwheel_site256_bit3_trial2/device.injected.bc'
...
16:                                               ; preds = %2
  ...
  %fi_f2i = bitcast float %17 to i32
  %fi_fx = xor i32 %fi_f2i, 8
  %fi_i2f = bitcast i32 %fi_fx to float
  br label %18

18:                                               ; preds = %16, %9
  %19 = phi float [ %15, %9 ], [ %fi_i2f, %16 ]
