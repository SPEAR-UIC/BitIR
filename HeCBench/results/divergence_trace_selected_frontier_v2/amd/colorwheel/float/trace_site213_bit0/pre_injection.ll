...
@__hip_cuid_513c4e9b7e2613df = addrspace(1) global i8 0
@llvm.compiler.used = appending addrspace(1) global [1 x ptr] [ptr addrspacecast (ptr addrspace(1) @__hip_cuid_513c4e9b7e2613df to ptr)], section "llvm.metadata"
