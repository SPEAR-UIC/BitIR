; ModuleID = '/tmp/bitir_amd_entropy_site474_bit30_trial1/device.injected.bc'
...
@__hip_cuid_98420034f6811b1c = addrspace(1) global i8 0
@llvm.compiler.used = appending addrspace(1) global [1 x ptr] [ptr addrspacecast (ptr addrspace(1) @__hip_cuid_98420034f6811b1c to ptr)], section "llvm.metadata"
...
152:                                              ; preds = %145
  ...
  %fi_flip = xor i32 %190, 1073741824
...
205:                                              ; preds = %192, %152, %150
  ...
  %207 = phi i32 [ %fi_flip, %152 ], [ 0, %150 ], [ 0, %192 ]
...
!3 = !DIFile(filename: "HeCBench/src/entropy-hip/main.cu", directory: "/ccs/home/mdunlavy/GPU_FI", checksumkind: CSK_MD5, checksum: "df85ce02bce9bc6c98c85cc1728e109c")
...
!18 = !DIFile(filename: "/ccs/home/mdunlavy/GPU_FI/HeCBench/src/entropy-hip/main.cu", directory: "/ccs/home/mdunlavy/GPU_FI", checksumkind: CSK_MD5, checksum: "df85ce02bce9bc6c98c85cc1728e109c")
!19 = !{!8, !20}
