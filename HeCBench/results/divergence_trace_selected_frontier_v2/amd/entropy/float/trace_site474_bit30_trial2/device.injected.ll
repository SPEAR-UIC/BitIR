; ModuleID = '/tmp/bitir_amd_entropy_site474_bit30_trial2/device.injected.bc'
...
@__hip_cuid_7cfc0cd12b96bade = addrspace(1) global i8 0
@llvm.compiler.used = appending addrspace(1) global [1 x ptr] [ptr addrspacecast (ptr addrspace(1) @__hip_cuid_7cfc0cd12b96bade to ptr)], section "llvm.metadata"
