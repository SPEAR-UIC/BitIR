; ModuleID = '/tmp/bitir_amd_entropy_site474_bit0_trial1/device.injected.bc'
...
@__hip_cuid_f481542129aa87e1 = addrspace(1) global i8 0
@llvm.compiler.used = appending addrspace(1) global [1 x ptr] [ptr addrspacecast (ptr addrspace(1) @__hip_cuid_f481542129aa87e1 to ptr)], section "llvm.metadata"
