; ModuleID = '/tmp/bitir_amd_entropy_site474_bit14_trial2/device.injected.bc'
...
@__hip_cuid_da59f381616d0afb = addrspace(1) global i8 0
@llvm.compiler.used = appending addrspace(1) global [1 x ptr] [ptr addrspacecast (ptr addrspace(1) @__hip_cuid_da59f381616d0afb to ptr)], section "llvm.metadata"
