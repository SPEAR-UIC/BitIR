; ModuleID = '/tmp/bitir_amd_dense-embedding_site385_bit31_trial1/device.injected.bc'
...
@__hip_cuid_2ff5bac8f1f51af2 = addrspace(1) global i8 0
@llvm.compiler.used = appending addrspace(1) global [1 x ptr] [ptr addrspacecast (ptr addrspace(1) @__hip_cuid_2ff5bac8f1f51af2 to ptr)], section "llvm.metadata"
