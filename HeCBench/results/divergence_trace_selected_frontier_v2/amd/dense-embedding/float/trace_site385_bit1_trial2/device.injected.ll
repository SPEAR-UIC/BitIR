; ModuleID = '/tmp/bitir_amd_dense-embedding_site385_bit1_trial2/device.injected.bc'
...
@__hip_cuid_ca2f6348e8ab000 = addrspace(1) global i8 0
@llvm.compiler.used = appending addrspace(1) global [1 x ptr] [ptr addrspacecast (ptr addrspace(1) @__hip_cuid_ca2f6348e8ab000 to ptr)], section "llvm.metadata"
