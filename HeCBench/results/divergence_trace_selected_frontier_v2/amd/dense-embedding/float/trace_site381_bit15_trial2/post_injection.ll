; ModuleID = '/tmp/bitir_amd_dense-embedding_site381_bit15_trial2/device.injected.bc'
...
@__hip_cuid_972f0e1ed0524cbe = addrspace(1) global i8 0
@llvm.compiler.used = appending addrspace(1) global [1 x ptr] [ptr addrspacecast (ptr addrspace(1) @__hip_cuid_972f0e1ed0524cbe to ptr)], section "llvm.metadata"
