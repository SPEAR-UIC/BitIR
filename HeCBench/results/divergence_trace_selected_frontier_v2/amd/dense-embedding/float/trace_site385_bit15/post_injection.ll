; ModuleID = '/tmp/bitir_amd_dense-embedding_site385_bit15_trial1/device.injected.bc'
...
@__hip_cuid_3cb6f1979f1aca62 = addrspace(1) global i8 0
@llvm.compiler.used = appending addrspace(1) global [1 x ptr] [ptr addrspacecast (ptr addrspace(1) @__hip_cuid_3cb6f1979f1aca62 to ptr)], section "llvm.metadata"
...
150:                                              ; preds = %145
  ...
  %fi_flip = xor i1 %151, true
  br i1 %fi_flip, label %205, label %192
