; ModuleID = '/tmp/bitir_amd_dense-embedding_site381_bit1_trial1/device.injected.bc'
...
@__hip_cuid_c0a35a7bf1328773 = addrspace(1) global i8 0
@llvm.compiler.used = appending addrspace(1) global [1 x ptr] [ptr addrspacecast (ptr addrspace(1) @__hip_cuid_c0a35a7bf1328773 to ptr)], section "llvm.metadata"
