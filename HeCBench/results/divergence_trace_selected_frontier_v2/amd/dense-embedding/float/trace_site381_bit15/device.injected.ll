; ModuleID = '/tmp/bitir_amd_dense-embedding_site381_bit15_trial1/device.injected.bc'
...
@__hip_cuid_788db9e6332fe59d = addrspace(1) global i8 0
@llvm.compiler.used = appending addrspace(1) global [1 x ptr] [ptr addrspacecast (ptr addrspace(1) @__hip_cuid_788db9e6332fe59d to ptr)], section "llvm.metadata"
