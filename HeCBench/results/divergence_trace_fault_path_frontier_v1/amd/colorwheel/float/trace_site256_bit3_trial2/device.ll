; ModuleID = '/ccs/home/mdunlavy/GPU_Fault_Injection/HeCBench/src/colorwheel-hip/main.cu'
...
@__hip_cuid_b5198231f49fe0ae = addrspace(1) global i8 0
@llvm.compiler.used = appending addrspace(1) global [1 x ptr] [ptr addrspacecast (ptr addrspace(1) @__hip_cuid_b5198231f49fe0ae to ptr)], section "llvm.metadata"
