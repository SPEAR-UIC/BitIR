; ModuleID = '/tmp/bitir_fault_path_colorwheel_site256_bit3_trial2/device.injected.bc'
...
127:                                              ; preds = %113
  ...
  %fi_f2i = bitcast float %139 to i32, !dbg !1915
  %fi_fx = xor i32 %fi_f2i, 8, !dbg !1915
  %fi_i2f = bitcast i32 %fi_fx to float, !dbg !1915
  %140 = fneg contract float %fi_i2f, !dbg !1915
