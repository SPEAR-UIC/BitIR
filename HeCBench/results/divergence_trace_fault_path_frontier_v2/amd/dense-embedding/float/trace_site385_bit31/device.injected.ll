; ModuleID = '/tmp/bitir_fault_path_dense-embedding_site385_bit31_trial1/device.injected.bc'
...
@__hip_cuid_57d1147ca406fbeb = addrspace(1) global i8 0
@llvm.compiler.used = appending addrspace(1) global [1 x ptr] [ptr addrspacecast (ptr addrspace(1) @__hip_cuid_57d1147ca406fbeb to ptr)], section "llvm.metadata"
