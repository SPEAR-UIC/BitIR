; ModuleID = '/tmp/bitir_fault_path_dense-embedding_site385_bit31_trial2/device.injected.bc'
...
@__hip_cuid_5f7ba9ed0912ac81 = addrspace(1) global i8 0
@llvm.compiler.used = appending addrspace(1) global [1 x ptr] [ptr addrspacecast (ptr addrspace(1) @__hip_cuid_5f7ba9ed0912ac81 to ptr)], section "llvm.metadata"
...
83:                                               ; preds = %73
  ...
  %fi_f2i = bitcast float %103 to i32, !dbg !1948
  %fi_fx = xor i32 %fi_f2i, -2147483648, !dbg !1948
  %fi_i2f = bitcast i32 %fi_fx to float, !dbg !1948
  %104 = fadd contract float %102, %fi_i2f, !dbg !1948
