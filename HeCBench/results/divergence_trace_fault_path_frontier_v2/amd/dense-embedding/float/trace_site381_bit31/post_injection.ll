; ModuleID = '/tmp/bitir_fault_path_dense-embedding_site381_bit31_trial1/device.injected.bc'
...
@__hip_cuid_7784715401517382 = addrspace(1) global i8 0
@llvm.compiler.used = appending addrspace(1) global [1 x ptr] [ptr addrspacecast (ptr addrspace(1) @__hip_cuid_7784715401517382 to ptr)], section "llvm.metadata"
...
83:                                               ; preds = %73
  ...
  %fi_f2i = bitcast float %101 to i32, !dbg !1937
  %fi_fx = xor i32 %fi_f2i, -2147483648, !dbg !1937
  %fi_i2f = bitcast i32 %fi_fx to float, !dbg !1937
  store float %fi_i2f, ptr %43, align 4, !dbg !1937
