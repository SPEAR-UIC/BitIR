; ModuleID = '/tmp/bitir_fault_path_dense-embedding_site381_bit31_trial2/device.injected.bc'
...
@__hip_cuid_be45c05010219b6 = addrspace(1) global i8 0
@llvm.compiler.used = appending addrspace(1) global [1 x ptr] [ptr addrspacecast (ptr addrspace(1) @__hip_cuid_be45c05010219b6 to ptr)], section "llvm.metadata"
