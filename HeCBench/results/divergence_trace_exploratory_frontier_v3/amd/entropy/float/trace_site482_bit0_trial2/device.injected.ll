; ModuleID = '/tmp/bitir_exploratory_amd_entropy_site482_bit0_trial2/device.injected.bc'
...
@__hip_cuid_8351653c27a48205 = addrspace(1) global i8 0
@llvm.compiler.used = appending addrspace(1) global [1 x ptr] [ptr addrspacecast (ptr addrspace(1) @__hip_cuid_8351653c27a48205 to ptr)], section "llvm.metadata"
