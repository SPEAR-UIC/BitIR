; ModuleID = '/tmp/bitir_exploratory_amd_entropy_site392_bit0_trial1/device.injected.bc'
...
@__hip_cuid_b4c490f385454f9c = addrspace(1) global i8 0
@llvm.compiler.used = appending addrspace(1) global [1 x ptr] [ptr addrspacecast (ptr addrspace(1) @__hip_cuid_b4c490f385454f9c to ptr)], section "llvm.metadata"
