...
@__hip_cuid_337a30ac158646f5 = addrspace(1) global i8 0
@llvm.compiler.used = appending addrspace(1) global [1 x ptr] [ptr addrspacecast (ptr addrspace(1) @__hip_cuid_337a30ac158646f5 to ptr)], section "llvm.metadata"
