...
@__hip_cuid_5920065b00d8d4fe = addrspace(1) global i8 0
@llvm.compiler.used = appending addrspace(1) global [1 x ptr] [ptr addrspacecast (ptr addrspace(1) @__hip_cuid_5920065b00d8d4fe to ptr)], section "llvm.metadata"
