; ModuleID = '/tmp/bitir_exploratory_amd_dense-embedding_site362_bit24_trial1/device.injected.bc'
...
@__hip_cuid_50b2f5649f8ed199 = addrspace(1) global i8 0
@llvm.compiler.used = appending addrspace(1) global [1 x ptr] [ptr addrspacecast (ptr addrspace(1) @__hip_cuid_50b2f5649f8ed199 to ptr)], section "llvm.metadata"
