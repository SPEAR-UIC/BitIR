; ModuleID = '/tmp/bitir_exploratory_amd_dense-embedding_site362_bit0_trial1/device.injected.bc'
...
@__hip_cuid_45a2b2f8b71e8f3d = addrspace(1) global i8 0
@llvm.compiler.used = appending addrspace(1) global [1 x ptr] [ptr addrspacecast (ptr addrspace(1) @__hip_cuid_45a2b2f8b71e8f3d to ptr)], section "llvm.metadata"
