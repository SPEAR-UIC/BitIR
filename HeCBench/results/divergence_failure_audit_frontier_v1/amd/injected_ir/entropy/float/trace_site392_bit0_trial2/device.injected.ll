; ModuleID = '/tmp/bitir_failure_audit_injected_ir_entropy_site392_bit0_trial2/device.injected.bc'
...
@__hip_cuid_3cb9ebfaa308ae6e = addrspace(1) global i8 0
@llvm.compiler.used = appending addrspace(1) global [1 x ptr] [ptr addrspacecast (ptr addrspace(1) @__hip_cuid_3cb9ebfaa308ae6e to ptr)], section "llvm.metadata"
