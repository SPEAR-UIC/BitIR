; ModuleID = '/tmp/bitir_failure_audit_injected_ir_entropy_site482_bit0_trial2/device.injected.bc'
...
@__hip_cuid_ee42e3da4add7a9d = addrspace(1) global i8 0
@llvm.compiler.used = appending addrspace(1) global [1 x ptr] [ptr addrspacecast (ptr addrspace(1) @__hip_cuid_ee42e3da4add7a9d to ptr)], section "llvm.metadata"
