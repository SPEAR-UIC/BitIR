; ModuleID = '/tmp/bitir_failure_audit_injected_ir_entropy_site392_bit0_trial1/device.injected.bc'
...
@__hip_cuid_804895db65077458 = addrspace(1) global i8 0
@llvm.compiler.used = appending addrspace(1) global [1 x ptr] [ptr addrspacecast (ptr addrspace(1) @__hip_cuid_804895db65077458 to ptr)], section "llvm.metadata"
