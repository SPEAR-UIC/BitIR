; ModuleID = '/tmp/bitir_failure_audit_injected_ir_entropy_site482_bit0_trial1/device.injected.bc'
...
@__hip_cuid_72be5e5e21f98fbf = addrspace(1) global i8 0
@llvm.compiler.used = appending addrspace(1) global [1 x ptr] [ptr addrspacecast (ptr addrspace(1) @__hip_cuid_72be5e5e21f98fbf to ptr)], section "llvm.metadata"
