; ModuleID = '/tmp/bitir_failure_audit_injected_ir_dense-embedding_site362_bit0_trial2/device.injected.bc'
...
@__hip_cuid_48944e5a22779a21 = addrspace(1) global i8 0
@llvm.compiler.used = appending addrspace(1) global [1 x ptr] [ptr addrspacecast (ptr addrspace(1) @__hip_cuid_48944e5a22779a21 to ptr)], section "llvm.metadata"
