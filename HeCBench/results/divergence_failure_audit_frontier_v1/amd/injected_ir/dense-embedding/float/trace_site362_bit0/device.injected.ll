; ModuleID = '/tmp/bitir_failure_audit_injected_ir_dense-embedding_site362_bit0_trial1/device.injected.bc'
...
@__hip_cuid_b605bb2796332fb9 = addrspace(1) global i8 0
@llvm.compiler.used = appending addrspace(1) global [1 x ptr] [ptr addrspacecast (ptr addrspace(1) @__hip_cuid_b605bb2796332fb9 to ptr)], section "llvm.metadata"
