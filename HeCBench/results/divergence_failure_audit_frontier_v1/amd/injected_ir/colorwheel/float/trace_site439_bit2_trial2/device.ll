...
@__hip_cuid_f9f5a46c405ad0e0 = addrspace(1) global i8 0
@llvm.compiler.used = appending addrspace(1) global [1 x ptr] [ptr addrspacecast (ptr addrspace(1) @__hip_cuid_f9f5a46c405ad0e0 to ptr)], section "llvm.metadata"
