...
@__hip_cuid_cfd9de177d7c7ef8 = addrspace(1) global i8 0
@llvm.compiler.used = appending addrspace(1) global [1 x ptr] [ptr addrspacecast (ptr addrspace(1) @__hip_cuid_cfd9de177d7c7ef8 to ptr)], section "llvm.metadata"
