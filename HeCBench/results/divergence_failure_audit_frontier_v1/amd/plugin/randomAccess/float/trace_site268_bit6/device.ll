...
@__hip_cuid_fa41922b63b23e3b = addrspace(1) global i8 0
@llvm.compiler.used = appending addrspace(1) global [1 x ptr] [ptr addrspacecast (ptr addrspace(1) @__hip_cuid_fa41922b63b23e3b to ptr)], section "llvm.metadata"
