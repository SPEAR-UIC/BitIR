; ModuleID = '/autofs/nccs-svm1_home2/mdunlavy/GPU_Fault_Injection/HeCBench/src/layout-hip/main.cu'
source_filename = "/autofs/nccs-svm1_home2/mdunlavy/GPU_Fault_Injection/HeCBench/src/layout-hip/main.cu"
...
@__hip_cuid_f5a09a54aab28144 = addrspace(1) global i8 0
@llvm.compiler.used = appending addrspace(1) global [1 x ptr] [ptr addrspacecast (ptr addrspace(1) @__hip_cuid_f5a09a54aab28144 to ptr)], section "llvm.metadata"
...
define protected amdgpu_kernel void @_Z9AoSKernelILi4096EEvPK9AppleTreePi(ptr addrspace(1) noalias noundef %0, ptr addrspace(1) noalias noundef %1) #4 comdat !dbg !1652 {
  ...
  %25 = addrspacecast ptr addrspace(1) %1 to ptr
  store ptr %25, ptr %17, align 8
  %26 = load ptr, ptr %17, align 8
  store ptr %24, ptr %18, align 8
    #dbg_declare(ptr addrspace(5) %11, !1666, !DIExpression(DIOpArg(0, ptr addrspace(5)), DIOpDeref(ptr)), !1676)
  store ptr %26, ptr %19, align 8
    #dbg_declare(ptr addrspace(5) %12, !1667, !DIExpression(DIOpArg(0, ptr addrspace(5)), DIOpDeref(ptr)), !1677)
    #dbg_declare(ptr addrspace(5) %13, !1668, !DIExpression(DIOpArg(0, ptr addrspace(5)), DIOpDeref(i32)), !1678)
  %27 = addrspacecast ptr addrspace(5) %8 to ptr
  %28 = addrspacecast ptr addrspace(5) %5 to ptr
  %29 = call i64 @__ockl_get_group_id(i32 noundef 0) #13, !dbg !1679
  %30 = trunc i64 %29 to i32, !dbg !1679
  %31 = addrspacecast ptr addrspace(5) %7 to ptr
  %32 = addrspacecast ptr addrspace(5) %4 to ptr
  %33 = call i64 @__ockl_get_local_size(i32 noundef 0) #13, !dbg !1698
  %34 = trunc i64 %33 to i32, !dbg !1698
  %35 = mul i32 %30, %34, !dbg !1713
  %36 = addrspacecast ptr addrspace(5) %6 to ptr
  %37 = addrspacecast ptr addrspace(5) %3 to ptr
  %38 = call i64 @__ockl_get_local_id(i32 noundef 0) #13, !dbg !1714
  %39 = trunc i64 %38 to i32, !dbg !1714
  %40 = add i32 %35, %39, !dbg !1729
  store i32 %40, ptr %20, align 4, !dbg !1678
    #dbg_declare(ptr addrspace(5) %14, !1671, !DIExpression(DIOpArg(0, ptr addrspace(5)), DIOpDeref(i32)), !1730)
  store i32 0, ptr %21, align 4, !dbg !1730
    #dbg_declare(ptr addrspace(5) %15, !1672, !DIExpression(DIOpArg(0, ptr addrspace(5)), DIOpDeref(i32)), !1731)
  store i32 0, ptr %22, align 4, !dbg !1731
  br label %41, !dbg !1732

41:                                               ; preds = %56, %2
  %42 = load i32, ptr %22, align 4, !dbg !1733
  %43 = icmp slt i32 %42, 4096, !dbg !1735
  br i1 %43, label %44, label %60, !dbg !1736

44:                                               ; preds = %41
  %45 = load ptr, ptr %18, align 8, !dbg !1737
  %46 = load i32, ptr %20, align 4, !dbg !1739
  %47 = zext i32 %46 to i64, !dbg !1737
  %48 = getelementptr inbounds %struct.AppleTree, ptr %45, i64 %47, !dbg !1737
  %49 = getelementptr inbounds %struct.AppleTree, ptr %48, i32 0, i32 0, !dbg !1740
  %50 = load i32, ptr %22, align 4, !dbg !1741
  %51 = sext i32 %50 to i64, !dbg !1737
  %52 = getelementptr inbounds [4096 x i32], ptr %49, i64 0, i64 %51, !dbg !1737
  %53 = load i32, ptr %52, align 4, !dbg !1737
  %54 = load i32, ptr %21, align 4, !dbg !1742
  %55 = add i32 %54, %53, !dbg !1742
  store i32 %55, ptr %21, align 4, !dbg !1742
  br label %56, !dbg !1743

56:                                               ; preds = %44
  %57 = load i32, ptr %22, align 4, !dbg !1744
  %58 = add nsw i32 %57, 1, !dbg !1744
  %59 = xor i32 %59, 65536, !dbg !1744
  store i32 %59, ptr %22, align 4, !dbg !1744
  br label %41, !dbg !1745, !llvm.loop !1746

60:                                               ; preds = %41
  %61 = load i32, ptr %21, align 4, !dbg !1748
  %62 = load ptr, ptr %19, align 8, !dbg !1749
  %63 = load i32, ptr %20, align 4, !dbg !1750
  %64 = zext i32 %63 to i64, !dbg !1749
  %65 = getelementptr inbounds i32, ptr %62, i64 %64, !dbg !1749
  store i32 %61, ptr %65, align 4, !dbg !1751
  ret void, !dbg !1752
}

; Function Attrs: convergent mustprogress noinline norecurse nounwind optnone
define protected amdgpu_kernel void @_Z9SoAKernelILi4096EEvPK13ApplesOnTreesPi(ptr addrspace(1) noalias noundef %0, ptr addrspace(1) noalias noundef %1) #4 comdat !dbg !1753 {
  %3 = alloca i32, align 4, addrspace(5)
  %4 = alloca i32, align 4, addrspace(5)
  %5 = alloca i32, align 4, addrspace(5)
  %6 = alloca i32, align 4, addrspace(5)
  ...
  %26 = load ptr, ptr %17, align 8
  store ptr %24, ptr %18, align 8
    #dbg_declare(ptr addrspace(5) %11, !1763, !DIExpression(DIOpArg(0, ptr addrspace(5)), DIOpDeref(ptr)), !1769)
  store ptr %26, ptr %19, align 8
    #dbg_declare(ptr addrspace(5) %12, !1764, !DIExpression(DIOpArg(0, ptr addrspace(5)), DIOpDeref(ptr)), !1770)
    #dbg_declare(ptr addrspace(5) %13, !1765, !DIExpression(DIOpArg(0, ptr addrspace(5)), DIOpDeref(i32)), !1771)
  %27 = addrspacecast ptr addrspace(5) %8 to ptr
  %28 = addrspacecast ptr addrspace(5) %5 to ptr
  %29 = call i64 @__ockl_get_group_id(i32 noundef 0) #13, !dbg !1772
  %30 = trunc i64 %29 to i32, !dbg !1772
  %31 = addrspacecast ptr addrspace(5) %7 to ptr
  %32 = addrspacecast ptr addrspace(5) %4 to ptr
  %33 = call i64 @__ockl_get_local_size(i32 noundef 0) #13, !dbg !1775
  %34 = trunc i64 %33 to i32, !dbg !1775
  %35 = mul i32 %30, %34, !dbg !1778
  %36 = addrspacecast ptr addrspace(5) %6 to ptr
  %37 = addrspacecast ptr addrspace(5) %3 to ptr
  %38 = call i64 @__ockl_get_local_id(i32 noundef 0) #13, !dbg !1779
  %39 = trunc i64 %38 to i32, !dbg !1779
  %40 = add i32 %35, %39, !dbg !1782
  store i32 %40, ptr %20, align 4, !dbg !1771
    #dbg_declare(ptr addrspace(5) %14, !1766, !DIExpression(DIOpArg(0, ptr addrspace(5)), DIOpDeref(i32)), !1783)
  store i32 0, ptr %21, align 4, !dbg !1783
    #dbg_declare(ptr addrspace(5) %15, !1767, !DIExpression(DIOpArg(0, ptr addrspace(5)), DIOpDeref(i32)), !1784)
  store i32 0, ptr %22, align 4, !dbg !1784
  br label %41, !dbg !1785

41:                                               ; preds = %56, %2
  %42 = load i32, ptr %22, align 4, !dbg !1786
  %43 = icmp slt i32 %42, 4096, !dbg !1788
  br i1 %43, label %44, label %59, !dbg !1789

44:                                               ; preds = %41
  %45 = load ptr, ptr %18, align 8, !dbg !1790
  %46 = load i32, ptr %22, align 4, !dbg !1792
  %47 = sext i32 %46 to i64, !dbg !1790
  %48 = getelementptr inbounds %struct.ApplesOnTrees, ptr %45, i64 %47, !dbg !1790
  %49 = getelementptr inbounds %struct.ApplesOnTrees, ptr %48, i32 0, i32 0, !dbg !1793
  %50 = load i32, ptr %20, align 4, !dbg !1794
  %51 = zext i32 %50 to i64, !dbg !1790
  %52 = getelementptr inbounds [4096 x i32], ptr %49, i64 0, i64 %51, !dbg !1790
  %53 = load i32, ptr %52, align 4, !dbg !1790
  %54 = load i32, ptr %21, align 4, !dbg !1795
  %55 = add i32 %54, %53, !dbg !1795
  store i32 %55, ptr %21, align 4, !dbg !1795
  br label %56, !dbg !1796

56:                                               ; preds = %44
  %57 = load i32, ptr %22, align 4, !dbg !1797
  %58 = add nsw i32 %57, 1, !dbg !1797
  store i32 %58, ptr %22, align 4, !dbg !1797
  br label %41, !dbg !1798, !llvm.loop !1799

59:                                               ; preds = %41
  %60 = load i32, ptr %21, align 4, !dbg !1801
  %61 = load ptr, ptr %19, align 8, !dbg !1802
  %62 = load i32, ptr %20, align 4, !dbg !1803
  %63 = zext i32 %62 to i64, !dbg !1802
  %64 = getelementptr inbounds i32, ptr %61, i64 %63, !dbg !1802
  store i32 %60, ptr %64, align 4, !dbg !1804
  ret void, !dbg !1805
}
...
define internal <2 x i64> @__ockl_hostcall_preview(i32 noundef %0, i64 noundef %1, i64 noundef %2, i64 noundef %3, i64 noundef %4, i64 noundef %5, i64 noundef %6, i64 noundef %7, i64 noundef %8) local_unnamed_addr #7 {
  %10 = load i32, ptr addrspace(4) @__oclc_ABI_version, align 4, !tbaa !1806
  ...
  %15 = load i64, ptr addrspace(4) %14, align 8, !tbaa !1810
...
16:                                               ; preds = %10
  ...
  %20 = load ptr addrspace(1), ptr addrspace(1) %14, align 8, !tbaa !1812
  %21 = load i64, ptr addrspace(1) %19, align 8, !tbaa !1816
  %22 = and i64 %21, %18
...
28:                                               ; preds = %28, %16
  ...
  %30 = load ptr addrspace(1), ptr addrspace(1) %14, align 8, !tbaa !1812
  %31 = load i64, ptr addrspace(1) %19, align 8, !tbaa !1816
  %32 = and i64 %31, %29
...
38:                                               ; preds = %28, %16, %10
  ...
  %49 = load ptr addrspace(1), ptr addrspace(1) %14, align 8, !tbaa !1812
  %50 = getelementptr i8, ptr addrspace(1) %14, i64 40
  %51 = load i64, ptr addrspace(1) %50, align 8, !tbaa !1816
  %52 = and i64 %48, %51
  %53 = getelementptr inbounds %0, ptr addrspace(1) %49, i64 %52
  %54 = getelementptr i8, ptr addrspace(1) %14, i64 8
  %55 = load ptr addrspace(1), ptr addrspace(1) %54, align 8, !tbaa !1817
...
58:                                               ; preds = %38
  ...
  store i32 %1, ptr addrspace(1) %59, align 8, !tbaa !1818
  store i64 %57, ptr addrspace(1) %60, align 8, !tbaa !1820
  store i32 1, ptr addrspace(1) %61, align 4, !tbaa !1821
  br label %62

62:                                               ; preds = %58, %38
  %63 = zext i32 %12 to i64
  %64 = getelementptr inbounds [64 x [8 x i64]], ptr addrspace(1) %56, i64 0, i64 %63
  store i64 %2, ptr addrspace(1) %64, align 8, !tbaa !1810
  %65 = getelementptr inbounds i8, ptr addrspace(1) %64, i64 8
  store i64 %3, ptr addrspace(1) %65, align 8, !tbaa !1810
  %66 = getelementptr inbounds i8, ptr addrspace(1) %64, i64 16
  store i64 %4, ptr addrspace(1) %66, align 8, !tbaa !1810
  %67 = getelementptr inbounds i8, ptr addrspace(1) %64, i64 24
  store i64 %5, ptr addrspace(1) %67, align 8, !tbaa !1810
  %68 = getelementptr inbounds i8, ptr addrspace(1) %64, i64 32
  store i64 %6, ptr addrspace(1) %68, align 8, !tbaa !1810
  %69 = getelementptr inbounds i8, ptr addrspace(1) %64, i64 40
  store i64 %7, ptr addrspace(1) %69, align 8, !tbaa !1810
  %70 = getelementptr inbounds i8, ptr addrspace(1) %64, i64 48
  store i64 %8, ptr addrspace(1) %70, align 8, !tbaa !1810
  %71 = getelementptr inbounds i8, ptr addrspace(1) %64, i64 56
  store i64 %9, ptr addrspace(1) %71, align 8, !tbaa !1810
...
72:                                               ; preds = %62
  ...
  %75 = load i64, ptr addrspace(1) %50, align 8, !tbaa !1816
  %76 = and i64 %75, %48
  %77 = getelementptr inbounds %0, ptr addrspace(1) %49, i64 %76
  store i64 %74, ptr addrspace(1) %77, align 8, !tbaa !1822
...
80:                                               ; preds = %80, %72
  ...
  tail call void @llvm.amdgcn.s.sleep(i32 1)
  store i64 %82, ptr addrspace(1) %77, align 8, !tbaa !1822
...
99:                                               ; preds = %94
  %100 = load i64, ptr addrspace(1) %64, align 8, !tbaa !1810
  %101 = load i64, ptr addrspace(1) %65, align 8, !tbaa !1810
  br i1 %15, label %102, label %120

102:                                              ; preds = %99
  %103 = load i64, ptr addrspace(1) %50, align 8, !tbaa !1816
  %104 = add i64 %103, 1
  %105 = add i64 %104, %48
  ...
  %110 = load ptr addrspace(1), ptr addrspace(1) %14, align 8, !tbaa !1812
  %111 = and i64 %107, %103
  %112 = getelementptr inbounds %0, ptr addrspace(1) %110, i64 %111
  store i64 %109, ptr addrspace(1) %112, align 8, !tbaa !1822
...
115:                                              ; preds = %115, %102
  ...
  tail call void @llvm.amdgcn.s.sleep(i32 1)
  store i64 %117, ptr addrspace(1) %112, align 8, !tbaa !1822
...
16:                                               ; preds = %14, %12, %10, %8, %6
  ...
  %18 = load i64, ptr addrspace(1) %17, align 16, !tbaa !1823
  %19 = icmp eq i64 %18, 0
...
20:                                               ; preds = %16
  ...
  %23 = load i32, ptr addrspace(1) %22, align 8, !tbaa !1825
  %24 = zext i32 %23 to i64
  store atomic i64 %24, ptr addrspace(1) %21 syncscope("one-as") release, align 8
  %25 = load i32, ptr addrspace(4) @__oclc_ISA_version, align 4, !tbaa !1806
...
72:                                               ; preds = %72, %30
  ...
  %77 = load i8, ptr %76, align 1, !tbaa !1826
...
132:                                              ; preds = %132, %90
  ...
  %137 = load i8, ptr %136, align 1, !tbaa !1826
...
192:                                              ; preds = %192, %150
  ...
  %197 = load i8, ptr %196, align 1, !tbaa !1826
...
252:                                              ; preds = %252, %210
  ...
  %257 = load i8, ptr %256, align 1, !tbaa !1826
...
312:                                              ; preds = %312, %270
  ...
  %317 = load i8, ptr %316, align 1, !tbaa !1826
...
372:                                              ; preds = %372, %330
  ...
  %377 = load i8, ptr %376, align 1, !tbaa !1826
...
430:                                              ; preds = %430, %390
  ...
  %435 = load i8, ptr %434, align 1, !tbaa !1826
...
5:                                                ; preds = %2
  ...
  %9 = load i16, ptr addrspace(4) %8, align 4, !range !1827, !invariant.load !1828, !noundef !1828
  %10 = zext nneg i16 %9 to i32
  %11 = getelementptr inbounds i8, ptr addrspace(4) %6, i64 12
  %12 = load i32, ptr addrspace(4) %11, align 4, !tbaa !1829
  %13 = mul i32 %7, %10
  %14 = sub i32 %12, %13
...
17:                                               ; preds = %2
  ...
  %20 = load i32, ptr addrspace(4) %19, align 4, !tbaa !1806
  %21 = icmp ult i32 %18, %20
  %22 = select i1 %21, i64 12, i64 18
  %23 = getelementptr inbounds i8, ptr addrspace(4) %19, i64 %22
  %24 = load i16, ptr addrspace(4) %23, align 2, !tbaa !1832
...
29:                                               ; preds = %26
  ...
  %33 = load i16, ptr addrspace(4) %32, align 2, !range !1827, !invariant.load !1828, !noundef !1828
  %34 = zext nneg i16 %33 to i32
  %35 = getelementptr inbounds i8, ptr addrspace(4) %30, i64 16
  %36 = load i32, ptr addrspace(4) %35, align 8, !tbaa !1833
  %37 = mul i32 %31, %34
  %38 = sub i32 %36, %37
...
41:                                               ; preds = %26
  ...
  %45 = load i32, ptr addrspace(4) %44, align 4, !tbaa !1806
  %46 = icmp ult i32 %42, %45
  %47 = select i1 %46, i64 14, i64 20
  %48 = getelementptr inbounds i8, ptr addrspace(4) %43, i64 %47
  %49 = load i16, ptr addrspace(4) %48, align 2, !tbaa !1832
...
54:                                               ; preds = %51
  ...
  %58 = load i16, ptr addrspace(4) %57, align 4, !range !1827, !invariant.load !1828, !noundef !1828
  %59 = zext nneg i16 %58 to i32
  %60 = getelementptr inbounds i8, ptr addrspace(4) %55, i64 20
  %61 = load i32, ptr addrspace(4) %60, align 4, !tbaa !1834
  %62 = mul i32 %56, %59
  %63 = sub i32 %61, %62
...
66:                                               ; preds = %51
  ...
  %70 = load i32, ptr addrspace(4) %69, align 4, !tbaa !1806
  %71 = icmp ult i32 %67, %70
  %72 = select i1 %71, i64 16, i64 22
  %73 = getelementptr inbounds i8, ptr addrspace(4) %68, i64 %72
  %74 = load i16, ptr addrspace(4) %73, align 2, !tbaa !1832
...
!1 = !DIFile(filename: "/autofs/nccs-svm1_home2/mdunlavy/GPU_Fault_Injection/HeCBench/src/layout-hip/main.cu", directory: "/autofs/nccs-svm1_home2/mdunlavy/GPU_Fault_Injection", checksumkind: CSK_MD5, checksum: "b6c5f2610590f74354c01429270c6140")
!2 = !{!3}
...
!571 = !DISubprogram(name: "abs", linkageName: "_ZSt3absg", scope: !20, file: !26, line: 137, type: !572, flags: DIFlagPrototyped, spFlags: 0)
!572 = !DISubroutineType(types: !573)
!573 = !{!574, !574}
!574 = !DIBasicType(name: "__float128", size: 128, encoding: DW_ATE_float)
...
!988 = !DIFile(filename: "HeCBench/src/layout-hip/main.cu", directory: "/autofs/nccs-svm1_home2/mdunlavy/GPU_Fault_Injection", checksumkind: CSK_MD5, checksum: "b6c5f2610590f74354c01429270c6140")
...
!1652 = distinct !DISubprogram(name: "AoSKernel<4096>", linkageName: "_Z9AoSKernelILi4096EEvPK9AppleTreePi", scope: !988, file: !988, line: 40, type: !1653, scopeLine: 42, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !0, templateParams: !1674, retainedNodes: !1665)
...
!1658 = distinct !DICompositeType(tag: DW_TAG_structure_type, name: "AppleTree", file: !988, line: 28, size: 131072, flags: DIFlagTypePassByValue, elements: !1659, identifier: "_ZTS9AppleTree")
!1659 = !{!1660}
!1660 = !DIDerivedType(tag: DW_TAG_member, name: "apples", scope: !1658, file: !988, line: 30, baseType: !1661, size: 131072)
!1661 = !DICompositeType(tag: DW_TAG_array_type, baseType: !25, size: 131072, elements: !1662)
!1662 = !{!1663}
!1663 = !DISubrange(count: 4096)
!1664 = !DIDerivedType(tag: DW_TAG_restrict_type, baseType: !60)
!1665 = !{!1666, !1667, !1668, !1671, !1672}
!1666 = !DILocalVariable(name: "trees", arg: 1, scope: !1652, file: !988, line: 40, type: !1655)
!1667 = !DILocalVariable(name: "outBuf", arg: 2, scope: !1652, file: !988, line: 41, type: !1664)
!1668 = !DILocalVariable(name: "gid", scope: !1652, file: !988, line: 43, type: !1669)
!1669 = !DIDerivedType(tag: DW_TAG_typedef, name: "uint", file: !1670, line: 40, baseType: !11)
!1670 = !DIFile(filename: "/opt/rocm-6.4.2/include/hip/amd_detail/device_library_decls.h", directory: "", checksumkind: CSK_MD5, checksum: "61416ae22a8962f94d70fdb29c9fe093")
!1671 = !DILocalVariable(name: "res", scope: !1652, file: !988, line: 44, type: !1669)
!1672 = !DILocalVariable(name: "i", scope: !1673, file: !988, line: 45, type: !25)
!1673 = distinct !DILexicalBlock(scope: !1652, file: !988, line: 45, column: 3)
!1674 = !{!1675}
!1675 = !DITemplateValueParameter(name: "treeSize", type: !25, value: i32 4096)
!1676 = !DILocation(line: 40, column: 46, scope: !1652)
!1677 = !DILocation(line: 41, column: 34, scope: !1652)
!1678 = !DILocation(line: 43, column: 8, scope: !1652)
!1679 = !DILocation(line: 270, column: 58, scope: !1680, inlinedAt: !1684)
!1680 = distinct !DISubprogram(name: "__hip_get_block_idx_x", linkageName: "_ZL21__hip_get_block_idx_xv", scope: !1681, file: !1681, line: 270, type: !1682, scopeLine: 270, flags: DIFlagPrototyped, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !0)
!1681 = !DIFile(filename: "/opt/rocm-6.4.2/include/hip/amd_detail/amd_hip_runtime.h", directory: "", checksumkind: CSK_MD5, checksum: "38097f6211bac4e19f9ae3395b411f76")
!1682 = !DISubroutineType(types: !1683)
!1683 = !{!11}
!1684 = distinct !DILocation(line: 300, column: 3, scope: !1685, inlinedAt: !1697)
!1685 = distinct !DISubprogram(name: "__get_x", linkageName: "_ZN24__hip_builtin_blockIdx_t7__get_xEv", scope: !1686, file: !1681, line: 300, type: !1682, scopeLine: 300, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !0, declaration: !1688)
!1686 = distinct !DICompositeType(tag: DW_TAG_structure_type, name: "__hip_builtin_blockIdx_t", file: !1681, line: 299, size: 8, flags: DIFlagTypePassByValue, elements: !1687, identifier: "_ZTS24__hip_builtin_blockIdx_t")
!1687 = !{!1688, !1689, !1690, !1691}
!1688 = !DISubprogram(name: "__get_x", linkageName: "_ZN24__hip_builtin_blockIdx_t7__get_xEv", scope: !1686, file: !1681, line: 300, type: !1682, scopeLine: 300, flags: DIFlagPrototyped | DIFlagStaticMember, spFlags: 0)
!1689 = !DISubprogram(name: "__get_y", linkageName: "_ZN24__hip_builtin_blockIdx_t7__get_yEv", scope: !1686, file: !1681, line: 301, type: !1682, scopeLine: 301, flags: DIFlagPrototyped | DIFlagStaticMember, spFlags: 0)
!1690 = !DISubprogram(name: "__get_z", linkageName: "_ZN24__hip_builtin_blockIdx_t7__get_zEv", scope: !1686, file: !1681, line: 302, type: !1682, scopeLine: 302, flags: DIFlagPrototyped | DIFlagStaticMember, spFlags: 0)
!1691 = !DISubprogram(name: "operator dim3", linkageName: "_ZNK24__hip_builtin_blockIdx_tcv4dim3Ev", scope: !1686, file: !1681, line: 304, type: !1692, scopeLine: 304, flags: DIFlagPrototyped, spFlags: 0)
!1692 = !DISubroutineType(types: !1693)
!1693 = !{!1694, !1695}
!1694 = !DIDerivedType(tag: DW_TAG_typedef, name: "dim3", file: !4, line: 1186, baseType: !3)
!1695 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !1696, size: 64, flags: DIFlagArtificial | DIFlagObjectPointer)
!1696 = !DIDerivedType(tag: DW_TAG_const_type, baseType: !1686)
!1697 = distinct !DILocation(line: 43, column: 14, scope: !1652)
!1698 = !DILocation(line: 275, column: 58, scope: !1699, inlinedAt: !1700)
!1699 = distinct !DISubprogram(name: "__hip_get_block_dim_x", linkageName: "_ZL21__hip_get_block_dim_xv", scope: !1681, file: !1681, line: 275, type: !1682, scopeLine: 275, flags: DIFlagPrototyped, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !0)
!1700 = distinct !DILocation(line: 309, column: 3, scope: !1701, inlinedAt: !1712)
!1701 = distinct !DISubprogram(name: "__get_x", linkageName: "_ZN24__hip_builtin_blockDim_t7__get_xEv", scope: !1702, file: !1681, line: 309, type: !1682, scopeLine: 309, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !0, declaration: !1704)
!1702 = distinct !DICompositeType(tag: DW_TAG_structure_type, name: "__hip_builtin_blockDim_t", file: !1681, line: 308, size: 8, flags: DIFlagTypePassByValue, elements: !1703, identifier: "_ZTS24__hip_builtin_blockDim_t")
!1703 = !{!1704, !1705, !1706, !1707}
!1704 = !DISubprogram(name: "__get_x", linkageName: "_ZN24__hip_builtin_blockDim_t7__get_xEv", scope: !1702, file: !1681, line: 309, type: !1682, scopeLine: 309, flags: DIFlagPrototyped | DIFlagStaticMember, spFlags: 0)
!1705 = !DISubprogram(name: "__get_y", linkageName: "_ZN24__hip_builtin_blockDim_t7__get_yEv", scope: !1702, file: !1681, line: 310, type: !1682, scopeLine: 310, flags: DIFlagPrototyped | DIFlagStaticMember, spFlags: 0)
!1706 = !DISubprogram(name: "__get_z", linkageName: "_ZN24__hip_builtin_blockDim_t7__get_zEv", scope: !1702, file: !1681, line: 311, type: !1682, scopeLine: 311, flags: DIFlagPrototyped | DIFlagStaticMember, spFlags: 0)
!1707 = !DISubprogram(name: "operator dim3", linkageName: "_ZNK24__hip_builtin_blockDim_tcv4dim3Ev", scope: !1702, file: !1681, line: 313, type: !1708, scopeLine: 313, flags: DIFlagPrototyped, spFlags: 0)
!1708 = !DISubroutineType(types: !1709)
!1709 = !{!1694, !1710}
!1710 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !1711, size: 64, flags: DIFlagArtificial | DIFlagObjectPointer)
!1711 = !DIDerivedType(tag: DW_TAG_const_type, baseType: !1702)
!1712 = distinct !DILocation(line: 43, column: 27, scope: !1652)
!1713 = !DILocation(line: 43, column: 25, scope: !1652)
!1714 = !DILocation(line: 265, column: 59, scope: !1715, inlinedAt: !1716)
!1715 = distinct !DISubprogram(name: "__hip_get_thread_idx_x", linkageName: "_ZL22__hip_get_thread_idx_xv", scope: !1681, file: !1681, line: 265, type: !1682, scopeLine: 265, flags: DIFlagPrototyped, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !0)
!1716 = distinct !DILocation(line: 291, column: 3, scope: !1717, inlinedAt: !1728)
!1717 = distinct !DISubprogram(name: "__get_x", linkageName: "_ZN25__hip_builtin_threadIdx_t7__get_xEv", scope: !1718, file: !1681, line: 291, type: !1682, scopeLine: 291, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !0, declaration: !1720)
!1718 = distinct !DICompositeType(tag: DW_TAG_structure_type, name: "__hip_builtin_threadIdx_t", file: !1681, line: 290, size: 8, flags: DIFlagTypePassByValue, elements: !1719, identifier: "_ZTS25__hip_builtin_threadIdx_t")
!1719 = !{!1720, !1721, !1722, !1723}
!1720 = !DISubprogram(name: "__get_x", linkageName: "_ZN25__hip_builtin_threadIdx_t7__get_xEv", scope: !1718, file: !1681, line: 291, type: !1682, scopeLine: 291, flags: DIFlagPrototyped | DIFlagStaticMember, spFlags: 0)
!1721 = !DISubprogram(name: "__get_y", linkageName: "_ZN25__hip_builtin_threadIdx_t7__get_yEv", scope: !1718, file: !1681, line: 292, type: !1682, scopeLine: 292, flags: DIFlagPrototyped | DIFlagStaticMember, spFlags: 0)
!1722 = !DISubprogram(name: "__get_z", linkageName: "_ZN25__hip_builtin_threadIdx_t7__get_zEv", scope: !1718, file: !1681, line: 293, type: !1682, scopeLine: 293, flags: DIFlagPrototyped | DIFlagStaticMember, spFlags: 0)
!1723 = !DISubprogram(name: "operator dim3", linkageName: "_ZNK25__hip_builtin_threadIdx_tcv4dim3Ev", scope: !1718, file: !1681, line: 295, type: !1724, scopeLine: 295, flags: DIFlagPrototyped, spFlags: 0)
...
!1728 = distinct !DILocation(line: 43, column: 40, scope: !1652)
!1729 = !DILocation(line: 43, column: 38, scope: !1652)
!1730 = !DILocation(line: 44, column: 8, scope: !1652)
!1731 = !DILocation(line: 45, column: 11, scope: !1673)
!1732 = !DILocation(line: 45, column: 7, scope: !1673)
!1733 = !DILocation(line: 45, column: 18, scope: !1734)
!1734 = distinct !DILexicalBlock(scope: !1673, file: !988, line: 45, column: 3)
!1735 = !DILocation(line: 45, column: 20, scope: !1734)
!1736 = !DILocation(line: 45, column: 3, scope: !1673)
!1737 = !DILocation(line: 47, column: 12, scope: !1738)
!1738 = distinct !DILexicalBlock(scope: !1734, file: !988, line: 46, column: 3)
!1739 = !DILocation(line: 47, column: 18, scope: !1738)
!1740 = !DILocation(line: 47, column: 23, scope: !1738)
!1741 = !DILocation(line: 47, column: 30, scope: !1738)
!1742 = !DILocation(line: 47, column: 9, scope: !1738)
!1743 = !DILocation(line: 48, column: 3, scope: !1738)
!1744 = !DILocation(line: 45, column: 33, scope: !1734)
!1745 = !DILocation(line: 45, column: 3, scope: !1734)
!1746 = distinct !{!1746, !1736, !1747, !1614}
!1747 = !DILocation(line: 48, column: 3, scope: !1673)
!1748 = !DILocation(line: 49, column: 17, scope: !1652)
!1749 = !DILocation(line: 49, column: 3, scope: !1652)
!1750 = !DILocation(line: 49, column: 10, scope: !1652)
!1751 = !DILocation(line: 49, column: 15, scope: !1652)
!1752 = !DILocation(line: 50, column: 1, scope: !1652)
!1753 = distinct !DISubprogram(name: "SoAKernel<4096>", linkageName: "_Z9SoAKernelILi4096EEvPK13ApplesOnTreesPi", scope: !988, file: !988, line: 54, type: !1754, scopeLine: 56, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !0, templateParams: !1674, retainedNodes: !1762)
...
!1759 = distinct !DICompositeType(tag: DW_TAG_structure_type, name: "ApplesOnTrees", file: !988, line: 33, size: 131072, flags: DIFlagTypePassByValue, elements: !1760, identifier: "_ZTS13ApplesOnTrees")
!1760 = !{!1761}
!1761 = !DIDerivedType(tag: DW_TAG_member, name: "trees", scope: !1759, file: !988, line: 35, baseType: !1661, size: 131072)
!1762 = !{!1763, !1764, !1765, !1766, !1767}
!1763 = !DILocalVariable(name: "applesOnTrees", arg: 1, scope: !1753, file: !988, line: 54, type: !1756)
!1764 = !DILocalVariable(name: "outBuf", arg: 2, scope: !1753, file: !988, line: 55, type: !1664)
!1765 = !DILocalVariable(name: "gid", scope: !1753, file: !988, line: 57, type: !1669)
!1766 = !DILocalVariable(name: "res", scope: !1753, file: !988, line: 58, type: !1669)
!1767 = !DILocalVariable(name: "i", scope: !1768, file: !988, line: 59, type: !25)
!1768 = distinct !DILexicalBlock(scope: !1753, file: !988, line: 59, column: 3)
!1769 = !DILocation(line: 54, column: 50, scope: !1753)
!1770 = !DILocation(line: 55, column: 34, scope: !1753)
!1771 = !DILocation(line: 57, column: 8, scope: !1753)
!1772 = !DILocation(line: 270, column: 58, scope: !1680, inlinedAt: !1773)
!1773 = distinct !DILocation(line: 300, column: 3, scope: !1685, inlinedAt: !1774)
!1774 = distinct !DILocation(line: 57, column: 14, scope: !1753)
!1775 = !DILocation(line: 275, column: 58, scope: !1699, inlinedAt: !1776)
!1776 = distinct !DILocation(line: 309, column: 3, scope: !1701, inlinedAt: !1777)
!1777 = distinct !DILocation(line: 57, column: 27, scope: !1753)
!1778 = !DILocation(line: 57, column: 25, scope: !1753)
!1779 = !DILocation(line: 265, column: 59, scope: !1715, inlinedAt: !1780)
!1780 = distinct !DILocation(line: 291, column: 3, scope: !1717, inlinedAt: !1781)
!1781 = distinct !DILocation(line: 57, column: 40, scope: !1753)
!1782 = !DILocation(line: 57, column: 38, scope: !1753)
!1783 = !DILocation(line: 58, column: 8, scope: !1753)
!1784 = !DILocation(line: 59, column: 11, scope: !1768)
!1785 = !DILocation(line: 59, column: 7, scope: !1768)
!1786 = !DILocation(line: 59, column: 18, scope: !1787)
!1787 = distinct !DILexicalBlock(scope: !1768, file: !988, line: 59, column: 3)
!1788 = !DILocation(line: 59, column: 20, scope: !1787)
!1789 = !DILocation(line: 59, column: 3, scope: !1768)
!1790 = !DILocation(line: 61, column: 12, scope: !1791)
!1791 = distinct !DILexicalBlock(scope: !1787, file: !988, line: 60, column: 3)
!1792 = !DILocation(line: 61, column: 26, scope: !1791)
!1793 = !DILocation(line: 61, column: 29, scope: !1791)
!1794 = !DILocation(line: 61, column: 35, scope: !1791)
!1795 = !DILocation(line: 61, column: 9, scope: !1791)
!1796 = !DILocation(line: 62, column: 3, scope: !1791)
!1797 = !DILocation(line: 59, column: 33, scope: !1787)
!1798 = !DILocation(line: 59, column: 3, scope: !1787)
!1799 = distinct !{!1799, !1789, !1800, !1614}
!1800 = !DILocation(line: 62, column: 3, scope: !1768)
!1801 = !DILocation(line: 63, column: 17, scope: !1753)
!1802 = !DILocation(line: 63, column: 3, scope: !1753)
!1803 = !DILocation(line: 63, column: 10, scope: !1753)
!1804 = !DILocation(line: 63, column: 15, scope: !1753)
!1805 = !DILocation(line: 64, column: 1, scope: !1753)
!1806 = !{!1807, !1807, i64 0}
!1807 = !{!"int", !1808, i64 0}
!1808 = !{!"omnipotent char", !1809, i64 0}
!1809 = !{!"Simple C/C++ TBAA"}
!1810 = !{!1811, !1811, i64 0}
!1811 = !{!"long", !1808, i64 0}
!1812 = !{!1813, !1814, i64 0}
!1813 = !{!"", !1814, i64 0, !1814, i64 8, !1815, i64 16, !1811, i64 24, !1811, i64 32, !1811, i64 40}
!1814 = !{!"any pointer", !1808, i64 0}
!1815 = !{!"hsa_signal_s", !1811, i64 0}
!1816 = !{!1813, !1811, i64 40}
!1817 = !{!1813, !1814, i64 8}
!1818 = !{!1819, !1807, i64 16}
!1819 = !{!"", !1811, i64 0, !1811, i64 8, !1807, i64 16, !1807, i64 20}
!1820 = !{!1819, !1811, i64 8}
!1821 = !{!1819, !1807, i64 20}
!1822 = !{!1819, !1811, i64 0}
!1823 = !{!1824, !1811, i64 16}
!1824 = !{!"amd_signal_s", !1811, i64 0, !1808, i64 8, !1811, i64 16, !1807, i64 24, !1807, i64 28, !1811, i64 32, !1811, i64 40, !1808, i64 48, !1808, i64 56}
!1825 = !{!1824, !1807, i64 24}
!1826 = !{!1808, !1808, i64 0}
!1827 = !{i16 1, i16 1025}
!1828 = !{}
!1829 = !{!1830, !1807, i64 12}
!1830 = !{!"hsa_kernel_dispatch_packet_s", !1831, i64 0, !1831, i64 2, !1831, i64 4, !1831, i64 6, !1831, i64 8, !1831, i64 10, !1807, i64 12, !1807, i64 16, !1807, i64 20, !1807, i64 24, !1807, i64 28, !1808, i64 32, !1814, i64 40, !1811, i64 48, !1815, i64 56}
!1831 = !{!"short", !1808, i64 0}
!1832 = !{!1831, !1831, i64 0}
!1833 = !{!1830, !1807, i64 16}
!1834 = !{!1830, !1807, i64 20}
