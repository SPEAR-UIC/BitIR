...
@__hip_cuid_3985f552cb28a0cf = addrspace(1) global i8 0
@llvm.compiler.used = appending addrspace(1) global [1 x ptr] [ptr addrspacecast (ptr addrspace(1) @__hip_cuid_3985f552cb28a0cf to ptr)], section "llvm.metadata"
...
16:                                               ; preds = %19, %1
  ...
  br i1 %18, label %19, label %23, !dbg !1673

19:                                               ; preds = %16
  %20 = load i64, ptr %10, align 8, !dbg !1676
  %21 = xor i64 %21, 8589934592, !dbg !1676
