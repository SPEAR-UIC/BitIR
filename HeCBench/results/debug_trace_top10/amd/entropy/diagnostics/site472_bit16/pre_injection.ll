...
define protected amdgpu_kernel void @_Z7entropyPfPKcii(ptr addrspace(1) noalias noundef %0, ptr addrspace(1) noalias noundef %1, i32 noundef %2, i32 noundef %3) #4 !dbg !1702 {
  ...
  %89 = add i32 %79, %88, !dbg !1809
  store i32 %89, ptr %47, align 4, !dbg !1792
  ...
  br label %90, !dbg !1812

90:                                               ; preds = %97, %4
  %91 = load i32, ptr %49, align 4, !dbg !1813
  %92 = icmp slt i32 %91, 16, !dbg !1815
  br i1 %92, label %93, label %100, !dbg !1816

93:                                               ; preds = %90
  %94 = load i32, ptr %49, align 4, !dbg !1817
  %95 = sext i32 %94 to i64, !dbg !1818
  %96 = getelementptr inbounds [16 x i8], ptr %48, i64 0, i64 %95, !dbg !1818
  store i8 0, ptr %96, align 1, !dbg !1819
  br label %97, !dbg !1818

97:                                               ; preds = %93
  %98 = load i32, ptr %49, align 4, !dbg !1820
  %99 = add nsw i32 %98, 1, !dbg !1820
  store i32 %99, ptr %49, align 4, !dbg !1820
  br label %90, !dbg !1821, !llvm.loop !1822
...
101:                                              ; preds = %149, %100
  %102 = load i32, ptr %51, align 4, !dbg !1827
  %103 = icmp sle i32 %102, 2, !dbg !1828
  br i1 %103, label %104, label %152, !dbg !1829
...
104:                                              ; preds = %101
  ...
  br label %105, !dbg !1831

105:                                              ; preds = %145, %104
  %106 = load i32, ptr %52, align 4, !dbg !1832
  %107 = icmp sle i32 %106, 2, !dbg !1833
  br i1 %107, label %108, label %148, !dbg !1834

108:                                              ; preds = %105
    #dbg_declare(ptr addrspace(5) %35, !1724, !DIExpression(DIOpArg(0, ptr addrspace(5)), DIOpDeref(i32)), !1835)
  %109 = load i32, ptr %46, align 4, !dbg !1836
  %110 = load i32, ptr %52, align 4, !dbg !1837
  %111 = add nsw i32 %109, %110, !dbg !1838
  store i32 %111, ptr %53, align 4, !dbg !1835
    #dbg_declare(ptr addrspace(5) %36, !1727, !DIExpression(DIOpArg(0, ptr addrspace(5)), DIOpDeref(i32)), !1839)
  %112 = load i32, ptr %47, align 4, !dbg !1840
  %113 = load i32, ptr %51, align 4, !dbg !1841
  %114 = add nsw i32 %112, %113, !dbg !1842
  store i32 %114, ptr %54, align 4, !dbg !1839
  %115 = load i32, ptr %53, align 4, !dbg !1843
  %116 = icmp sge i32 %115, 0, !dbg !1845
  br i1 %116, label %117, label %144, !dbg !1846

117:                                              ; preds = %108
  %118 = load i32, ptr %54, align 4, !dbg !1847
  %119 = icmp sge i32 %118, 0, !dbg !1848
  br i1 %119, label %120, label %144, !dbg !1849

120:                                              ; preds = %117
  %121 = load i32, ptr %54, align 4, !dbg !1850
  %122 = load i32, ptr %44, align 4, !dbg !1851
  %123 = icmp slt i32 %121, %122, !dbg !1852
  br i1 %123, label %124, label %144, !dbg !1853

124:                                              ; preds = %120
  %125 = load i32, ptr %53, align 4, !dbg !1854
  %126 = load i32, ptr %45, align 4, !dbg !1855
  %127 = icmp slt i32 %125, %126, !dbg !1856
  br i1 %127, label %128, label %144, !dbg !1857

128:                                              ; preds = %124
  %129 = load ptr, ptr %43, align 8, !dbg !1858
  %130 = load i32, ptr %54, align 4, !dbg !1860
  %131 = load i32, ptr %45, align 4, !dbg !1861
  %132 = mul nsw i32 %130, %131, !dbg !1862
  %133 = load i32, ptr %53, align 4, !dbg !1863
  %134 = add nsw i32 %132, %133, !dbg !1864
  %135 = sext i32 %134 to i64, !dbg !1858
  %136 = getelementptr inbounds i8, ptr %129, i64 %135, !dbg !1858
  %137 = load i8, ptr %136, align 1, !dbg !1858
  %138 = sext i8 %137 to i64, !dbg !1865
  %139 = getelementptr inbounds [16 x i8], ptr %48, i64 0, i64 %138, !dbg !1865
  %140 = load i8, ptr %139, align 1, !dbg !1866
  %141 = add i8 %140, 1, !dbg !1866
  store i8 %141, ptr %139, align 1, !dbg !1866
  %142 = load i8, ptr %50, align 1, !dbg !1867
  %143 = add i8 %142, 1, !dbg !1867
  store i8 %143, ptr %50, align 1, !dbg !1867
  br label %144, !dbg !1868

144:                                              ; preds = %128, %124, %120, %117, %108
  br label %145, !dbg !1869

145:                                              ; preds = %144
  %146 = load i32, ptr %52, align 4, !dbg !1870
  %147 = add nsw i32 %146, 1, !dbg !1870
  store i32 %147, ptr %52, align 4, !dbg !1870
  br label %105, !dbg !1871, !llvm.loop !1872

148:                                              ; preds = %105
  br label %149, !dbg !1874

149:                                              ; preds = %148
  %150 = load i32, ptr %51, align 4, !dbg !1875
  %151 = add nsw i32 %150, 1, !dbg !1875
  store i32 %151, ptr %51, align 4, !dbg !1875
  br label %101, !dbg !1876, !llvm.loop !1877
...
152:                                              ; preds = %101
  ...
  %153 = load i8, ptr %50, align 1, !dbg !1880
  %154 = sext i8 %153 to i32, !dbg !1880
  %155 = icmp slt i32 %154, 1, !dbg !1881
  br i1 %155, label %156, label %157, !dbg !1882

156:                                              ; preds = %152
  store i8 1, ptr %50, align 1, !dbg !1883
  br label %188, !dbg !1885
...
158:                                              ; preds = %184, %157
  %159 = load i32, ptr %56, align 4, !dbg !1888
  %160 = icmp slt i32 %159, 16, !dbg !1889
  br i1 %160, label %161, label %187, !dbg !1890

161:                                              ; preds = %158
    #dbg_declare(ptr addrspace(5) %39, !1733, !DIExpression(DIOpArg(0, ptr addrspace(5)), DIOpDeref(float)), !1891)
  %162 = load i32, ptr %56, align 4, !dbg !1892
  %163 = sext i32 %162 to i64, !dbg !1893
  %164 = getelementptr inbounds [16 x i8], ptr %48, i64 0, i64 %163, !dbg !1893
  %165 = load i8, ptr %164, align 1, !dbg !1893
  %166 = sitofp i8 %165 to float, !dbg !1893
  %167 = load i8, ptr %50, align 1, !dbg !1894
  %168 = sitofp i8 %167 to float, !dbg !1894
  ...
  %172 = load float, ptr %170, align 4, !dbg !1902
  %173 = load float, ptr %171, align 4, !dbg !1903
  %174 = fdiv contract float %172, %173, !dbg !1904
  store float %174, ptr %57, align 4, !dbg !1891
  %175 = load float, ptr %57, align 4, !dbg !1905
  %176 = load float, ptr %57, align 4, !dbg !1906
  ...
  %179 = load float, ptr %178, align 4, !dbg !1909
  %180 = call contract noundef float @__ocml_log2_f32(float noundef %179) #14, !dbg !1910
  %181 = fmul contract float %175, %180, !dbg !1911
  %182 = load float, ptr %55, align 4, !dbg !1912
  %183 = fsub contract float %182, %181, !dbg !1912
  store float %183, ptr %55, align 4, !dbg !1912
  br label %184, !dbg !1913

184:                                              ; preds = %161
  %185 = load i32, ptr %56, align 4, !dbg !1914
  %186 = add nsw i32 %185, 1, !dbg !1914
  store i32 %186, ptr %56, align 4, !dbg !1914
  br label %158, !dbg !1915, !llvm.loop !1916

187:                                              ; preds = %158
  br label %188

188:                                              ; preds = %187, %156
  %189 = load i32, ptr %47, align 4, !dbg !1918
  %190 = load i32, ptr %44, align 4, !dbg !1920
  %191 = icmp slt i32 %189, %190, !dbg !1921
  br i1 %191, label %192, label %206, !dbg !1922

192:                                              ; preds = %188
  %193 = load i32, ptr %46, align 4, !dbg !1923
  %194 = load i32, ptr %45, align 4, !dbg !1924
  %195 = icmp slt i32 %193, %194, !dbg !1925
  br i1 %195, label %196, label %206, !dbg !1926

196:                                              ; preds = %192
  %197 = load float, ptr %55, align 4, !dbg !1927
  %198 = load ptr, ptr %42, align 8, !dbg !1928
  %199 = load i32, ptr %47, align 4, !dbg !1929
  %200 = load i32, ptr %45, align 4, !dbg !1930
  %201 = mul nsw i32 %199, %200, !dbg !1931
  %202 = load i32, ptr %46, align 4, !dbg !1932
  %203 = add nsw i32 %201, %202, !dbg !1933
  %204 = sext i32 %203 to i64, !dbg !1928
  %205 = getelementptr inbounds float, ptr %198, i64 %204, !dbg !1928
  store float %197, ptr %205, align 4, !dbg !1934
  br label %206, !dbg !1928
