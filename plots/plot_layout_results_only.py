...
summary = '/home/mdunlavy/GPU_FI/HeCBench/results/llvm17_inject/layout/summary.csv'
...
label_to_val = {'MASKED':0, 'SDC':1, 'FAILURE':2, 'UNKNOWN':3}
vals = [label_to_val.get(res, 3) for _,_,res in rows]

arr = np.array(vals)[None, :]
res_cmap = ListedColormap(['#2ca02c', '#ff7f0e', '#0066FF', '#ffffff'])

fig_w = max(10, len(vals)/200)
fig_h = 1.8
fig, ax = plt.subplots(1,1, figsize=(fig_w, fig_h))

ax.imshow(arr, aspect='auto', cmap=res_cmap, interpolation='nearest', vmin=0, vmax=3)
