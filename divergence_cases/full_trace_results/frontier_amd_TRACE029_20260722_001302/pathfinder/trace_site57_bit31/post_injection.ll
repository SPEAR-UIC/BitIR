; ModuleID = '/ccs/home/mdunlavy/GPU_FI/divergence_cases/full_trace_results/frontier_amd_TRACE029_20260722_001302/tmp/pathfinder_site57_bit31/device.injected.bc'
...
@__hip_cuid_587f94708cd4fe02 = addrspace(1) global i8 0
@llvm.compiler.used = appending addrspace(1) global [1 x ptr] [ptr addrspacecast (ptr addrspace(1) @__hip_cuid_587f94708cd4fe02 to ptr)], section "llvm.metadata"
...
define protected amdgpu_kernel void @_Z10pathfinderPKiS0_PiS1_iiiii(ptr addrspace(1) noalias noundef %0, ptr addrspace(1) noalias noundef %1, ptr addrspace(1) noalias noundef %2, ptr addrspace(1) noalias noundef %3, i32 noundef %4, i32 noundef %5, i32 noundef %6, i32 noundef %7, i32 noundef %8) #4 !dbg !2 {
  ...
  %fi_flip = xor i32 %107, -2147483648, !dbg !1767
  store i32 %fi_flip, ptr %65, align 4, !dbg !1767
...
!390 = distinct !DICompositeType(tag: DW_TAG_structure_type, file: !42, line: 59, size: 64, flags: DIFlagFwdDecl, identifier: "_ZTS5div_t")
...
!885 = distinct !DICompositeType(tag: DW_TAG_class_type, name: "exception_ptr", scope: !887, file: !886, line: 97, size: 64, flags: DIFlagFwdDecl | DIFlagNonTrivial, identifier: "_ZTSNSt15__exception_ptr13exception_ptrE")
...
!929 = distinct !DICompositeType(tag: DW_TAG_structure_type, name: "_IO_FILE", file: !928, line: 4, flags: DIFlagFwdDecl | DIFlagNonTrivial, identifier: "_ZTS8_IO_FILE")
...
!1049 = distinct !DICompositeType(tag: DW_TAG_structure_type, name: "tm", file: !919, line: 94, flags: DIFlagFwdDecl | DIFlagNonTrivial, identifier: "_ZTS2tm")
...
!1159 = distinct !DICompositeType(tag: DW_TAG_structure_type, name: "lconv", file: !1160, line: 51, size: 768, flags: DIFlagFwdDecl, identifier: "_ZTS5lconv")
...
!1210 = distinct !DICompositeType(tag: DW_TAG_structure_type, name: "_G_fpos_t", file: !1209, line: 10, size: 128, flags: DIFlagFwdDecl, identifier: "_ZTS9_G_fpos_t")
