; ModuleID = '/ccs/home/mdunlavy/GPU_FI/divergence_cases/runtime_debug/trace029/results/frontier_amd_TRACE029_runtime_debug_20260722_135225/tmp/pathfinder_injected/device.injected.bc'
...
@__hip_cuid_1ac3859de95c8a3e = addrspace(1) global i8 0
@llvm.compiler.used = appending addrspace(1) global [1 x ptr] [ptr addrspacecast (ptr addrspace(1) @__hip_cuid_1ac3859de95c8a3e to ptr)], section "llvm.metadata"
...
define protected amdgpu_kernel void @_Z10pathfinderPKiS0_PiS1_P21Trace029RuntimeRecordPjS4_S4_iiiii(ptr addrspace(1) noalias noundef %0, ptr addrspace(1) noalias noundef %1, ptr addrspace(1) noalias noundef %2, ptr addrspace(1) noalias noundef %3, ptr addrspace(1) noundef %4, ptr addrspace(1) noundef %5, ptr addrspace(1) noundef %6, ptr addrspace(1) noundef %7, i32 noundef %8, i32 noundef %9, i32 noundef %10, i32 noundef %11, i32 noundef %12) #4 !dbg !2 {
  ...
  %fi_flip = xor i32 %161, -2147483648, !dbg !1823
  store i32 %fi_flip, ptr %96, align 4, !dbg !1823
...
!413 = distinct !DICompositeType(tag: DW_TAG_structure_type, file: !65, line: 59, size: 64, flags: DIFlagFwdDecl, identifier: "_ZTS5div_t")
...
!908 = distinct !DICompositeType(tag: DW_TAG_class_type, name: "exception_ptr", scope: !910, file: !909, line: 97, size: 64, flags: DIFlagFwdDecl | DIFlagNonTrivial, identifier: "_ZTSNSt15__exception_ptr13exception_ptrE")
...
!952 = distinct !DICompositeType(tag: DW_TAG_structure_type, name: "_IO_FILE", file: !951, line: 4, flags: DIFlagFwdDecl | DIFlagNonTrivial, identifier: "_ZTS8_IO_FILE")
...
!1072 = distinct !DICompositeType(tag: DW_TAG_structure_type, name: "tm", file: !942, line: 94, flags: DIFlagFwdDecl | DIFlagNonTrivial, identifier: "_ZTS2tm")
...
!1182 = distinct !DICompositeType(tag: DW_TAG_structure_type, name: "lconv", file: !1183, line: 51, size: 768, flags: DIFlagFwdDecl, identifier: "_ZTS5lconv")
...
!1233 = distinct !DICompositeType(tag: DW_TAG_structure_type, name: "_G_fpos_t", file: !1232, line: 10, size: 128, flags: DIFlagFwdDecl, identifier: "_ZTS9_G_fpos_t")
